...
export const HELP_CONTENT: Record<string, HelpContent> = {
  agenda: {
    ...
    sections: [
      { icon: <Calendar size={16} />, color: 'var(--blue)', title: 'Visualizações', text: 'Alterne entre Semana, Mês, Dia e Lista no topo. Clique em qualquer horário vazio para criar um evento.' },
  ...
  tarefas: {
    ...
    sections: [
      { icon: <CheckSquare size={16} />, color: 'var(--blue)', title: 'Inbox, Hoje e Próximos 7 dias', text: 'Inbox guarda tarefas sem data ou projeto. Hoje e Próximos 7 dias mostram automaticamente o que está vencendo.' },
  ...
  projetos: {
    ...
    sections: [
      { icon: <Folder size={16} />, color: 'var(--blue)', title: 'Status e progresso', text: 'Cada projeto tem um status (em andamento, concluído) e uma barra de progresso baseada nos itens marcados.' },
  ...
  metas: {
    ...
    sections: [
      ...
      { icon: <Folder size={16} />, color: 'var(--blue)', title: 'Áreas', text: 'Classifique metas por área da vida (Saúde, Finanças, Estudos) para organizar visualmente.' },
    ],
  },
  habitos: {
  ...
  estudos: {
    ...
    sections: [
      ...
      { icon: <Target size={16} />, color: 'var(--blue)', title: 'Cursos e estudos', text: 'Acompanhe cursos e certificações em andamento com barra de progresso.' },
    ],
  },
  senhas: {
    ...
    sections: [
      ...
      { icon: <FileText size={16} />, color: 'var(--blue)', title: 'Revelar senha', text: 'Toque no nome do serviço para revelar a senha temporariamente. Use o botão de copiar para colar direto onde precisar.' },
    ],
  },
}
